...
public abstract class Player extends GameObject {
    ...
    protected void playerWalking() {
        ...
        if (Keyboard.isKeyDown(MOVE_LEFT_KEY2) || Keyboard.isKeyDown(MOVE_LEFT_KEY)) {
        ...
        // if walk right key is pressed, move player to the right
            ...
            moveAmountX += walkSpeed;
            facingDirection = Direction.RIGHT;
        } else if (Keyboard.isKeyUp(MOVE_LEFT_KEY) || Keyboard.isKeyUp(MOVE_LEFT_KEY2) && Keyboard.isKeyUp(MOVE_RIGHT_KEY) ||Keyboard.isKeyDown(MOVE_RIGHT_KEY2)) {
            playerState = PlayerState.STANDING;
        }
